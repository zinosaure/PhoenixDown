...
class SettingsManager(private val context: Context, sharedPreferences: Lazy<SharedPreferences>) {
    ...
    suspend fun theGamesDbApiKey(): String {
        val userKey = stringPreference(R.string.settings_title_thegamesdb_apikey, "")
        return if (userKey.isNotBlank()) {
            userKey
        } else {
            DEFAULT_THEGAMESDB_API_KEY
        }
    }
    ...
    companion object {
        private const val DEFAULT_THEGAMESDB_API_KEY = "128a74668e6485681f7c3ca62fc4e52ec696830cd8bffc85a391c09c0157b598"
    }
}
