...
import com.swordfish.lemuroid.app.tv.catalog.TVCatalogActivity
...
abstract class LemuroidTVApplicationModule {
    ...
    @PerActivity
    @ContributesAndroidInjector(modules = [TVCatalogActivity.Module::class])
    abstract fun tvCatalogActivity(): TVCatalogActivity
}
