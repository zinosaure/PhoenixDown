...
abstract class LemuroidApplicationModule {
    ...
    companion object {
        ...
        fun gameMetadataProvider(
            ...
            // Two-phase metadata: LibretroDB detects system, TheGamesDB enriches metadata
            return CompositeMetadataProvider(
                ...
                enrichmentProviders = listOf(
                    TheGamesDBMetadataProvider(shortTimeoutClient, settingsManager)
                )
            )
        }
        ...
        fun sourceRepository(context: Context): SourceRepository =
            SourceRepository(context).also { it.migrateOldPrefsIfNeeded() }
        ...
        ): StorageProvider = StorageAccessFrameworkProvider(context, sourceRepository)
        ...
        fun gameStorageProviderRegistry(
            ...
            sourceRepository: SourceRepository,
        ) = StorageProviderRegistry(context, providers, sourceRepository)
