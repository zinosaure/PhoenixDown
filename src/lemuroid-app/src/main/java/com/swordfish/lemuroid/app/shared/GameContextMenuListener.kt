...
class GameContextMenuListener(
    ...
    override fun onCreateContextMenu(
        ...
        // Rename option (TV)
        menu.add(R.string.game_context_menu_edit).setOnMenuItemClickListener {
            gameInteractor.onRenameGame(game)
            true
        }
        
        // Change system option
        menu.add(com.swordfish.lemuroid.lib.R.string.game_context_menu_change_system).setOnMenuItemClickListener {
            gameInteractor.onChangeSystem(game)
            true
        }
        
        // Delete option
        menu.add(R.string.game_context_menu_delete).setOnMenuItemClickListener {
            gameInteractor.onDeleteGame(game)
            true
        }
    }
}
