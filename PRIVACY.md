# Privacy Policy for Retromul

**Last Updated:** December 17, 2024

This Privacy Policy describes how Retromul ("we", "our", or "the App") handles your information.

## 1. Data Collection and Usage

**We do not collect, store, or share any personal identification information (PII).**

Retromul is an open-source emulator designed to function locally on your device. We do not have any external servers that harvest user data.
...
*   The App only accesses the specific folder created for Retromul saves, not your entire Drive.
...
https://github.com/rolemiaster/Retromul
